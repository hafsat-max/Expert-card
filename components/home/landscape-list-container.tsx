      ...
      >
        {landscapes?.map((item) => {
          ...
          if (item.card_type === "Landscape1") {
            ...
            // portrait 2 card type
            return (
              <section className=" flex flex-col justify-center items-center gap-1">
                <div
                  className=" bg-white w-[272px] flex gap-10 justify-center p-3 items-center  h-[169.72px] border rounded-lg overflow-hidden bg-cover"
                  style={{
                    backgroundImage: "url('/grey-gradient.png')",
                  }}
                >
                  <img src={item.qr_code} className=" w-[70px] h-[70px]"></img>
                  ...
                  <img src="/afex-logo.svg" alt="" className="w-[147px] h-[12px] absolute top-[90px] left-[19px]" />
                  </div>
                </div>
