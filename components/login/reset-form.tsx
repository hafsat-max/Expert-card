  ...
  return (
    ...
    >
      ...
      <section className="flex-1 flex justify-center items-center">
        ...
        <Paragraph style="max-w-[340px] mx-auto pt-5 text-spanish-gray" text="Enter your email address below, and we’ll email you a 6-digit pin to reset your password."/>
        ...
        <form className={clsx("pt-10 flex flex-col gap-6")}>
          ...
          <Link href={"/authentication"} className="mb-[clamp(40px, 5vw, 70px)]">
            <Button
